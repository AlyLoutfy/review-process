  ...
  return (
    <>
      <div className={`rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 p-6 relative overflow-hidden ${isReviewed ? "bg-gradient-to-br from-green-50 to-green-100/50 border-2 border-green-400/60" : hasIssues ? "bg-gradient-to-br from-red-50 to-red-100/50 border-2 border-red-400/60" : "bg-white border border-gray-200 hover:border-blue-300 hover:shadow-lg hover:bg-gradient-to-br hover:from-blue-50/30 hover:to-white"}`}>
        ...
        <div className="absolute top-5 right-5 flex flex-col items-end gap-2 z-10 w-full max-w-[140px]">
          <div className="flex flex-col items-end w-full">
            <button onClick={handleToggle} className={`group flex items-center gap-1.5 px-3 py-2 rounded-lg transition-all duration-200 cursor-pointer w-full justify-center ${isReviewed ? "bg-green-100 hover:bg-green-200 border border-green-300 shadow-sm" : "bg-white hover:bg-green-50 border border-gray-300 hover:border-green-300 shadow-sm"}`} aria-label={isReviewed ? "Mark as pending" : "Mark as reviewed"} title={isReviewed ? "Mark as pending" : "Mark as reviewed"}>
          ...
          <div className="relative z-50 w-full">
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-2 rounded-lg transition-all duration-200 cursor-pointer relative group w-full justify-center ${hasIssues ? "bg-red-100 hover:bg-red-200 border border-red-300 shadow-sm" : "bg-white hover:bg-red-50 border border-gray-300 hover:border-red-300 shadow-sm"}`}
